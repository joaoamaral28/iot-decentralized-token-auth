...
#define _Header_MessageType_MAX Header_MessageType_ErrorMsg
#define _Header_MessageType_ARRAYSIZE ((Header_MessageType)(Header_MessageType_ErrorMsg+1))
...
#define MessageRequest_init_default              {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define DriversInfoMessage_init_default          {{{NULL}, NULL}}
...
#define MessageRequest_init_zero                 {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define DriversInfoMessage_init_zero             {{{NULL}, NULL}}
...
extern const pb_field_t MessageRequest_fields[3];
